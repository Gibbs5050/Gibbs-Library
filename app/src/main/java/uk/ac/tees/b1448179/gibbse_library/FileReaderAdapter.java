...
public class FileReaderAdapter extends RecyclerView.Adapter<FileReaderAdapter.ViewHolder>{
    ...
    public FileReaderAdapter(Context context, File[] filesAndFolders){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedFile.isDirectory()){
                    ...
                    Intent intent = new Intent(context, WebSwitchActivity.class);
                    intent.putExtra("url", selectedFile);//show web view
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(intent);
                }
                else{
